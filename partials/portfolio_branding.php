...
<div id="branding-and-logo">
  ...
  <div id="font-section">
    <div>
      <img class="img-responsive" src="<?php the_field('font_one_image') ?>"/>
      <div class="separator" style="border-color: <?php the_field('text_color') ?>"></div>
    ...
    <div>
      <img class="img-responsive" src="<?php the_field('font_two_image') ?>"/>
      <div class="separator" style="border-color: <?php the_field('text_color') ?>"></div>
