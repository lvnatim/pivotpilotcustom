<footer>
  ...
  <div id="section-footer" class="container-fluid">
    <div class="row">
      <div class="col-xs-12">
        <div class="title-container alternate footer-title-container">
          <a href="#"><p class="title">BOOK A FREE CONSULTATION</p></a>
        </div>
        <div class="text-container footer-text-container">
          <h3>604.458.2345</h3>
          ...
          <div class="small-icons-container">
            ...
            <a target="_blank" href="https://twitter.com/pivotandpilot" class="icon-container small-icon-container">
              <img class="img-responsive svg" src="<?php echo get_template_directory_uri() . '/dist/icons/twitter.svg' ?>"/>
            </a>
            <a target="_blank" href="https://www.linkedin.com/company/pivot-&-pilot-creative" class="icon-container small-icon-container">
              <img class="img-responsive svg" src="<?php echo get_template_directory_uri() . '/dist/icons/linkedin.svg' ?>"/>
            </a>
            <a target="_blank" href="https://www.instagram.com/pivotandpilot/" class="icon-container small-icon-container">
              <img class="img-responsive svg" src="<?php echo get_template_directory_uri() . '/dist/icons/instagram.svg' ?>"/>
            </a>
          </div>
        </div>
        <p id="copyright">2016 &copy; Pivot &amp; Pilot Inc.</p>
      </div>
    </div>
  </div>

  <div id="section-mobile-footer" class="container-fluid">
    <div class="row">
      <div class="col-xs-12">
        <div class="title-container alternate footer-title-container">
          <a href="#"><p class="title">BOOK A FREE CONSULTATION</p></a>
